...
-- Sensor DHT11 is connected to GPIO2 pin = 4
Humidity = 0
HumidityDec=0
Temperature = 0
TemperatureDec=0
...
conn:send("GET /update?key="..apikey.."&field1="..Temperature.."."..TemperatureDec.."&field2="..Humidity.."."..HumidityDec.." HTTP/1.1\r\n") 
...
tmr.alarm(2, publish_delay, 1, function() sendData() end )
